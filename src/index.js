...
class PupiPuppeteerSDK {
   ...
   * This method creates a temporary browser instance, runs the steps, and closes it.
   * @param {Array} steps - Array of step objects to execute.
   * @param {Object} params - Optional parameters to replace in step values.
   * @returns {Promise<any>} - The result of the final step.
   */
  async executeStepsLocally(steps, params = {}) {
    ...
    try {
      ...
      await puppeteerManager.close(instance.id);
    }
  }
